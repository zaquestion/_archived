...
namespace Engine
{
    ...
    public class Camera2D : Camera
    {
        ...
        public Camera2D(Vector2 Pos)
        {
            ...
            this.Cnt = new Vector3(Graphics.Width / 2, Graphics.Height / 2, 0.0f);
            this.View = Matrix.CreateScale(Scl) * Matrix.CreateTranslation(Cnt - this.Pos);
            this.Proj = Matrix.CreateOrthographicOffCenter(0, Graphics.Width - 1, Graphics.Height - 1, 0, 0, 1);
        }
        ...
        {
            View =/* Matrix.CreateTranslation(-Cnt) * Matrix.CreateScale(Scl, Scl, 0) * Matrix.CreateTranslation(Cnt) * */  Matrix.CreateTranslation((Cnt - Pos) * Scl);
        }
